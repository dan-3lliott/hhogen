...
plot(current, rates, col = "dodgerblue", type = "l",lwd = 2.5, xlab = "Current (A)", ylab = "Rate of Oxyhydrogen Gas Production (ml/sec)", main = "Rate of Oxyhydrogen Gas Production vs. Current", xaxt = "n", yaxt = "n")
